...
class aresta
{
	public:
		...
		aresta(float newx, float newy)
		{
			x = newx;
			y = newy;
		}

		aresta(float newx, float newy, int newo)
		{
			x = newx;
			y = newy;
			o = newo;
		...
		void setNext(float newnx, float newny)
		{
			nx = newnx;
			ny = newny;
		}

		void setNext(float newnx, float newny, int newno)
		{
			nx = newnx;
			ny = newny;
			no = newno;
		...
		aresta& operator=(const aresta& copy)
		{
			x = copy.x;
			y = copy.y;
			nx = copy.nx;
